                      ...
                      <div className="text-center space-y-3">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-baseline justify-center gap-2">
                            <p className="text-3xl font-bold text-blue-400">${product.price.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                            {product.originalPrice && (
                              <span className="text-lg text-gray-400 line-through">${product.originalPrice.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                            )}
                          </div>
                          {discount > 0 && (
                            <p className="text-md font-semibold text-green-400">Save {discount}%</p>
                          )}
                          ...
                          <div className="pt-2">
                            <Button asChild className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 text-md transition-transform hover:scale-105">

  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${darkMode ? "dark bg-gray-950" : "bg-white"}`}>
        ...
        <div className="container mx-auto px-4">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Button
                variant="outline"
                className="hidden md:inline-flex border-gray-700 text-white hover:bg-gray-800 bg-transparent"
              >
                Sign In
              </Button>
      ...
      <section className="py-16 bg-gray-950">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">Featured Categories</h2>
            <p className="text-gray-400 text-lg">Discover premium products across our verified categories</p>
          </div>
            ...
            <CardContent className="p-8">
              <div className="grid lg:grid-cols-2 gap-8 items-center">
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <h4 className="text-xl font-semibold text-white">Get my book FREE with your first transaction</h4>
      ...
      <section className="py-16 bg-gray-950">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">Premium Products</h2>
            <p className="text-gray-400 text-lg">Handpicked high-value items from verified sellers</p>
          </div>
      ...
      <section className="py-16 bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 text-lg">Your protection is our priority</p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <Card className="bg-gray-900/80 border-blue-500/30 backdrop-blur max-w-2xl mx-auto">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-300 mb-6">Get 5% off your first order</p>
              ...
              <p className="text-sm text-gray-400 mb-2">Extra 5% off when paying with Bitcoin</p>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 mb-4">The premier marketplace for authenticated high-value goods.</p>
